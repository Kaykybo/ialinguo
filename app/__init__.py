...
def create_app():
    ...
    from app.routes import auth_bp, conversa_bp, historico_bp, questionario_bp

    app.register_blueprint(auth_bp,         url_prefix='/api/auth')
    app.register_blueprint(conversa_bp,     url_prefix='/api/conversas')
    app.register_blueprint(historico_bp,    url_prefix='/api/historico')
    app.register_blueprint(questionario_bp, url_prefix='/api/questionarios')
